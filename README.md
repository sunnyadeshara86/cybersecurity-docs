...
- [Security Posture](https://github.com/sunnyadeshara86/cybersecurity-docs/blob/master/security-posture.md)
...
- Active sensors
- Threat intelligence
- Investigating an incidence
- Recovery process
- Vulnerability management
- Log analysis

## Below are the topics that are covered in the second part which is cloud security posture management:
